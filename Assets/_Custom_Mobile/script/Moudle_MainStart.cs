...
public class Moudle_MainStart : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        go_start.transform.FindChild("buttoms/startbutton").GetComponent<tk2dUIItem>().OnClick += start_Click;
        go_start.transform.FindChild("buttoms/function").GetComponent<tk2dUIItem>().OnClick += Help_Click;
        go_start.transform.FindChild("buttoms/chengjiu").GetComponent<tk2dUIItem>().OnClick += Achievement_Click;
        go_start.transform.FindChild("buttoms/paihangbang").GetComponent<tk2dUIItem>().OnClick += Rank_Click;
